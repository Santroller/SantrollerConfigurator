...
public partial class ConfigView : ReactiveUserControl<ConfigViewModel>
{
    ...
    protected async void DoSaveConfigAsync(InteractionContext<ConfigViewModel, Unit> obj)
    {
    ...
    protected async void DoLoadConfigAsync(InteractionContext<ConfigViewModel, Unit> obj)
    {
        var extension = "." + obj.Input.Microcontroller.Board.ArdwiinoName + "config";
    ...
    protected async Task DoShowUnpluggedDialogAsync(
    ...
    protected async Task DoShowYesNoDialogAsync(
        InteractionContext<(string yesText, string noText, string text), AreYouSureWindowViewModel> interaction)
    {
        var model = new AreYouSureWindowViewModel(ViewModel!.Main.AccentedButtonTextColor, interaction.Input.yesText, interaction.Input.noText,
            interaction.Input.text);
    ...
    protected async Task DoShowBindAllDialogAsync(
