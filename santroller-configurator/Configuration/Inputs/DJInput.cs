...
public partial class DjInput : TwiInput
{
    ...
    public DjInput(UsbHostInputType input, ConfigViewModel model, bool peripheral, int sda = -1,
        int scl = -1, bool combined = false) : base(
        input, DjTwiType, DjTwiFreq, peripheral, sda, scl, model, combined)
    {
    ...
    public override string Field => "lastSuccessfulDjhPacket";
