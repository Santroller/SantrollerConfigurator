...
public class Ps2Input : SpiInput
{
    ...
    private static readonly Dictionary<Ps2InputType, string> Mappings = new()
    {
        ...
        {Ps2InputType.Dualshock2RightButton, "ps2Data[9] << 8"},
        {Ps2InputType.Dualshock2LeftButton, "ps2Data[10] << 8"},
        {Ps2InputType.Dualshock2UpButton, "ps2Data[11] << 8"},
        {Ps2InputType.Dualshock2DownButton, "ps2Data[12] << 8"},
        {Ps2InputType.Dualshock2Triangle, "ps2Data[13] << 8"},
        {Ps2InputType.Dualshock2Circle, "ps2Data[14] << 8"},
        {Ps2InputType.Dualshock2Cross, "ps2Data[15] << 8"},
        {Ps2InputType.Dualshock2Square, "ps2Data[16] << 8"},
        {Ps2InputType.Dualshock2L1, "ps2Data[17] << 8"},
        {Ps2InputType.Dualshock2R1, "ps2Data[18] << 8"},
    ...
    public Ps2Input(Ps2InputType input, ConfigViewModel model, bool peripheral, int miso = -1,
        int mosi = -1,
        ...
        Ps2SpiCpha, Ps2SpiMsbFirst, miso: miso, mosi: mosi, sck: sck, model: model)
    {
        ...
        _attConfig = Model.GetPinForType(Ps2AttType, peripheral, att, DevicePinMode.Output);
