...
{
    public SerializedDjButton()
    {
        LedIndex = [];
        LedIndexPeripheral = [];
        LedIndexMpr121 = [];
    }
    public SerializedDjButton(SerializedInput input, bool enabled, Color ledOn, Color ledOff, byte[] ledIndex, byte[] ledIndexPeripheral, int debounce,
    ...
    public override Output Generate(ConfigViewModel model)
    {
        ...
        var combined = new DjButton(model, Enabled, Input.Generate(model), Color.FromUInt32(LedOn),
