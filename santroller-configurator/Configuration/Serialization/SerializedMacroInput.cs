...
public class SerializedMacroInput : SerializedInput
{
    ...
    public override Input Generate(ConfigViewModel model)
    {
        ...
        model.Bindings.Add(new ControllerButton(model, Child1.Generate(model), Colors.Transparent, Colors.Transparent, Array.Empty<byte>(),Array.Empty<byte>(), 10, StandardButtonType.A, false));
