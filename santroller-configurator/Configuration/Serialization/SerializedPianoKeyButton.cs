...
[ProtoContract]
public class SerializedPianoKeyButton : SerializedOutput
{
    public SerializedPianoKeyButton()
    {
        LedIndex = [];
        LedIndexMpr121 = [];
        LedIndexPeripheral = [];
    }
    public SerializedPianoKeyButton(SerializedInput input, Color ledOn, Color ledOff, byte[] ledIndex, byte[] ledIndexPeripheral,
    ...
    public override Output Generate(ConfigViewModel model)
    {
        ...
        var combined = new PianoKeyButton(model, Enabled,Input.Generate(model), Color.FromUInt32(LedOn),
