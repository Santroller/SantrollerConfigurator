...
- Peripheral microcontroller
    - This allows for putting a secondary microcontroller inside the neck of a guitar, or the platter of a turntable, to
      allow things like LEDs and frets over less pins, without compromising poll rate
